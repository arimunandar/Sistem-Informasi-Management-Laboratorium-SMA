                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    $sql    =   mysqliquery($koneksi,"SELECT * FROM semester WHERE semester_id='$semester'");
                                    $row    =   mysqli_fetch_array($sql);
                        ...
                        <form role="form" method="post">
                            <?php 
                                if (isset($_POST['cari-nilai'])) {
                                    ...
                                    $psikomotor =   mysqli_query($koneksi,"SELECT users.id, users.name, users.access, kelas.kelas_nama FROM users
