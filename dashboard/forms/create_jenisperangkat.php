			...
			<div class="grid-body">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="nama" placeholder="Enter Nama Jenis" required>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4 btn-group">
							<button type="submit" class="btn btn-primary" name="create-jenisperangkat"><span class="fa fa-save"></span> Create</button>
